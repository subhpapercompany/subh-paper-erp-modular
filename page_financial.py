...
color: #123b5e; letter-spacing: 2px; white-space: nowrap; line-height: 1.05;
  ...
  .h-main { display: flex; flex-direction: column; margin-top: 0.5in; }
  ...
  .lh-body * { font-family: "Times New Roman", Times, serif; font-size: 13px; }
  .lh-ft { font-family: "Times New Roman", Times, serif; }
  .lh-ft * { font-family: "Times New Roman", Times, serif; font-size: 13px; }
  .h-title { font-family: "Playfair Display", Georgia, serif; font-size: 16px; }
  @media print {
